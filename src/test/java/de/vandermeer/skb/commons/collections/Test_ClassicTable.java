...
import de.vandermeer.skb.base.utils.collections.SortedSetStrategy;
...
public class Test_ClassicTable {
	...
	@Test public void testAddRow(){
		...
		FlatTable<String> table=new FlatTable<String>(SetStrategy.HASH_SET, c);
	...
	@Test public void testAddRowsAll(){	//for Object[] and Collection<?>
		...
		SortedSet<String> set=SortedSetStrategy.TREE_SET.get(String.class);//TODO
		set.add("r6");
		set.add("r7");
	...
	@Test public void testConstructorArray(){
		FlatTable<String> table=new FlatTable<String>(SetStrategy.LINKED_HASH_SET, (IsAttributeKey[])null);
		...
		table=new FlatTable<String>(SetStrategy.HASH_SET, c);
		this.constructorAll(table);
	...
	@Test public void testConstructorCollection(){
		FlatTable<String> table=new FlatTable<String>(SetStrategy.LINKED_HASH_SET, (Collection<IsAttributeKey>)null);
		this.constructorAll(table);
		assertEquals(SetStrategy.LINKED_HASH_SET, table.strategy);
	...
	@Test public void testConstructorPlain(){
		FlatTable<String> table=new FlatTable<String>();
	...
	@Test public void testContains(){
		FlatTable<Integer> table=new FlatTable<Integer>();
